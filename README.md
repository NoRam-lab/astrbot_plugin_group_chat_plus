...
[![Version](https://img.shields.io/badge/version-v1.2.3-blue.svg)](https://github.com/Him666233/astrbot_plugin_group_chat_plus)
...
**本次更新以稳定性修复和精细化优化为主，涵盖 Smart 并发可靠性增强、消息处理链路补全、Web 面板兼容性与健壮性提升、判断型 AI 推理日志优化，以及全部说明文档的补充与更新。**
